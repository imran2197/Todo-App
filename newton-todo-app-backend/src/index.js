...
app.use(cors({
  credentials: true,
  origin: "https://newton-todo-app.herokuapp.com"
}));
...
// connect
const db = mongoose.createConnection("mongodb+srv://samimdimran786:@farahramsha1234@newtonmongo.u498f.mongodb.net/TodoApp?retryWrites=true&w=majority", {
