...
export default function TodoList(props) {
  ...
  const addItem = () => {
    ...
    fetch("https://newton-todo-app-backend.herokuapp.com/todo", {
      method: "POST",
  ...
  const deleteHandler = (itemIdx) => {
    ...
    fetch(`https://newton-todo-app-backend.herokuapp.com/todo/${idToDelete}`, {
  ...
  const editHandler = (editedValue, itemIdx) => {
    ...
    fetch(`https://newton-todo-app-backend.herokuapp.com/todo/${idToEdit}`, {
      method: "PUT",
  ...
  useEffect(() => {
    fetch("https://newton-todo-app-backend.herokuapp.com/todo", { credentials: "include" })
      .then((r) => r.json())
      .then((arr) => {
